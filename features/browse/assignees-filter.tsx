...
export function AssigneesFilter() {
  ...
  return (
    ...
    >
      <SelectTrigger className="bg-secondary text-secondary-foreground font-medium shadow-sm hover:bg-secondary/80 relative w-[180px] rounded-full border-none ps-9">
